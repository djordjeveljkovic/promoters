        ...
        <nav class="ds-stack-sm">
            <a href="{{ route('settings.profile') }}" wire:navigate
               @class([
                   ...
                   request()->routeIs('settings.profile') ? 'bg-indigo-50 text-indigo-700 dark:bg-indigo-500/10 dark:text-indigo-300' : 'text-[color:var(--ds-text-muted)] hover:bg-[color:var(--ds-bg-subtle)] hover:text-[color:var(--ds-text)]',
               ])>
            ...
            <a href="{{ route('settings.password') }}" wire:navigate
               @class([
                   'flex items-center gap-2 px-3 py-2 rounded-md text-sm font-medium',
                   request()->routeIs('settings.password') ? 'bg-indigo-50 text-indigo-700 dark:bg-indigo-500/10 dark:text-indigo-300' : 'text-[color:var(--ds-text-muted)] hover:bg-[color:var(--ds-bg-subtle)] hover:text-[color:var(--ds-text)]',
               ])>
